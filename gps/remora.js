function startup(Cesium) {
    ...
    function getToday() {
        ...
        XHR.addEventListener('load', function(event) {
            ...
            td1.appendChild(document.createTextNode('Captura'));
            td2.appendChild(document.createTextNode('Recibida'));
            td3.appendChild(document.createTextNode('Lat'));
            td4.appendChild(document.createTextNode('Long'));
            td5.appendChild(document.createTextNode('Alt'));
            td6.appendChild(document.createTextNode('Zoom'));
            td7.appendChild(document.createTextNode('Anterior'));
